...
class Envs:
    ...
    # Minimal DSpark PD PoC (metadata-buffer handoff; Prefill may omit DSPARK).
    SGLANG_DSPARK_PD_ENABLE_PREFILL_CAPTURE = EnvBool(True)
    SGLANG_DSPARK_PD_TARGET_LAYER_IDS = EnvStr("")
    SGLANG_DSPARK_PD_PREFILL_TAIL_TOKENS = EnvInt(0)
